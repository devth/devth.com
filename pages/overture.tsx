    ...
    <Layout>
      <Grid container>
        <Grid item xs={8}>
          ...
          <p>
            We are inundated with programming posts of varying quality. This is
            a curated list of only the best or most important I've come across.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              — The view on learning and applying knowledge described here is
              one I've long held and argued for. This post uses an intuitive
              analogy of runtime complexity to describe learning a concept and
              the cost of applying it over time.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              still don't get it? This was the case for me and learning Haskell
              is what made it finally click. As a bonus, this book is also
              hilarious and brilliantly written and illustrated; one of my
              all-time favorites.
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              algorithm. Even if you're not interested in Raft itself, go
              through this because it demonstrates so well the power of
              visualization in understanding complex interactions. (How can we
              get this level of quality in our own systems' documentation?)
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              (YouTube) — A wonderful and highly entertaining talk about
              writing. We should pursue excellence in this area as knowledge
              workers since writing is a core part of what we do.
            </li>
          </ul>
          ...
          <blockquote>
            ...
            <p>
              ...
              in a way that is above critics or attempts to cover all bases, to
              be impenetrable.
            </p>
            ...
            <p>
              Classic prose gives the reader credit for knowing that many
              concepts are hard to define, many controversies hard to resolve.
            ...
            <p>
              ...
              describing a non-linear graph of knowledge. It presents some bits
              of information to the reader before others, affecting the way the
            ...
            <p>
              They begin with the outcome of an event, and then throw in the
