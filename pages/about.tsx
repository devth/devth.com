    ...
    <Grid container>
      ...
      <Grid item xs={12} sm={8}>
        ...
        <p>
          ...
          web and mobile apps. Cares about Developer Experience as much as User
          Experience. Very interested in making your life easier.
        </p>
        <p>
          I wield technology to build great products and experiences and strive
          toward doing exactly that at every layer of the stack:
        </p>
        <ul>
          <li>
        ...
        <p>
          Strong proponent of using automation to make processes more efficient
          and repeatable. I build an open source chat bot called{" "}
