...
thinking about the qualities of Staff+. I'm not going to enumerate these (check
the book for that!), but instead consider one particular quality.
...
every company I've worked for over the last 20+ years. It's rare to escape the
sticky gravity well of perma-alpha. (One trick for doing it is to open source
your thing).
