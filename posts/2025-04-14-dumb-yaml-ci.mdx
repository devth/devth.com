...
Should have just used a real programming language. Same concept applies to
Terraform (bad) and CDK (better).
...
Then we throw that out and replace it with 1000 line dumb yamls.
